        ...
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                ...
                <form role="form" name="localisation" method="post" action="{$_url}settings/lc-post">
                    ...
                    <div class="form-group">
                        <label for="lan">{$_L['Date Format']}</label>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="lan" id="lan">
                            <option value="arabic"  {if $_c['language'] eq 'arabic'} selected="selected" {/if}>العربية
                            </option>
                            <option value="bengali" {if $_c['language'] eq 'bengali'} selected="selected" {/if}>
                                বাংলা
                            </option>
                            <option value="azerbaijani" {if $_c['language'] eq 'azerbaijani'} selected="selected" {/if}>
                            Azerbaijani
                            </option>
                            <option value="catalan" {if $_c['language'] eq 'catalan'} selected="selected" {/if}>
                                Català
                            </option>
                    ...
                    <div class="form-group">
                        <label for="currency_code">{$_L['Currency Code']}</label>
