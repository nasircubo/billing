    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            {$_L['Income minus Expense']} = {$_c['currency_code']} {number_format($aime,2,$_c['dec_point'],$_c['thousands_sep'])}
                <hr>
                <h5>{$_L['Total Expense This Month']}: {$_c['currency_code']} {number_format($mi,2,$_c['dec_point'],$_c['thousands_sep'])}</h5>
                <h5>{$_L['Total Income This Month']}: {$_c['currency_code']} {number_format($me,2,$_c['dec_point'],$_c['thousands_sep'])}</h5>
                <hr>
