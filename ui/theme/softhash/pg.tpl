    ...
    <div class="col-md-12">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <a href="{$_url}reorder/pg/" class="btn btn-primary"><i class="fa fa-arrows"></i> {$_L['Reorder Payment Gateways']}</a>
                <br>
                <table class="table table-bordered table-hover sys_table">
                    ...
                    {foreach $d as $ds}
                        <tr>
                            <td>{counter} </td>
                            <td><a href="{$_url}settings/pg-conf/{$ds['id']}/"><img src="ui/lib/imgs/pg/{$ds['processor']}.png" </a> </td>
