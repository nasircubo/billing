...
(67, 'country_code', 'US'),
(68, 'df', 'M d Y'),
(69, 'caddress', 'iBilling <br> 111 Gulshan Avenue  (Ground Floor)<br>Gulshan 2 <br> Dhaka - 1212'),
(70, 'account_search', '1'),
...
(1, 'demo@example.com', 'Administrator', '', '$1$WN..nD2.$Vo9niDl/fUf0VhheEjmHe/', 'Admin', 'Active', '2015-06-07 22:32:23', '', '2014-10-20 01:43:07', 'No', 'No', '$1$ZW/.uF5.$.rwCeLiguoBzYzf3waOnY1', '', 'No', '', '0');
...
ALTER TABLE `sys_email_templates`
 ADD PRIMARY KEY (`id`,`language_id`), ADD KEY `tplname` (`tplname`(32));
...
ALTER TABLE `sys_invoiceitems`
 ADD PRIMARY KEY (`id`), ADD KEY `invoiceid` (`invoiceid`);

--
-- Indexes for table `sys_invoices`
--
ALTER TABLE `sys_invoices`
 ADD PRIMARY KEY (`id`), ADD KEY `userid` (`userid`), ADD KEY `status` (`status`(3));
...
--
ALTER TABLE `sys_pg`
 ADD PRIMARY KEY (`id`), ADD KEY `gateway_setting` (`name`(32),`processor`(32)), ADD KEY `setting_value` (`processor`(32),`ins`(32));
...
--
ALTER TABLE `sys_tax`
 ADD PRIMARY KEY (`id`), ADD KEY `state_country` (`state`(32),`country`(2));
