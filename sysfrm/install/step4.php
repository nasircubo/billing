...
';
    ...
    $fh = fopen($wConfig, 'w') or die("Can't create config file, your server does not support 'fopen' function, or file does not have write permission
 please create a file named - config.php inside sysfrm folder with following contents- <br/>
 $input
 ");
    fwrite($fh, $input);
    fclose($fh);
