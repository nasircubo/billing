...
<head>
    ...
    <link rel="apple-touch-icon" sizes="57x57" href="sysfrm/uploads/icon/apple-icon-57x57.png">
...
<div id="page-wrap">
    ...
    <table width="100%">
        <tr>
            ...
            <span style="font-size: 18px; color: #2f4f4f"><strong><?php
                    echo $_L['INVOICE']; ?> # <?php
                   if($d['cn'] != ''){
                       $dispid = $d['cn'];
                   }
            ...
            <td style="border: 0;  text-align: right" width="62%"><div id="logo">
                    <img id="image" src="sysfrm/uploads/system/logo.png" alt="logo" /> <br>
    ...
    <table id="items">
        ...
        foreach ($items as $item){
            ...
            <td align="right">'.$config['currency_code'].' '.number_format($item['amount'],2,$config['dec_point'],$_c['thousands_sep']).'</td>
            <td align="right">'.$item['qty'].'</td>
            <td align="right"><span class="price">'.$config['currency_code'].' '.number_format($item['total'],2,$config['dec_point'],$_c['thousands_sep']).'</span></td>
        </tr>';
        }
        ...
        ?>
            ...
            <tr>
                ...
                <td class="total-value"><div id="subtotal"><?php echo $config['currency_code']; ?> <?php echo number_format($d['subtotal'],2,$config['dec_point'],$_c['thousands_sep']); ?></div></td>
            </tr>
            <?php
            if(($d['discount']) != '0.00'){
           ...
           ?>
            <tr>
                ...
                <td class="total-value"><div id="subtotal"><?php echo $config['currency_code']; ?> <?php echo number_format($d['discount'],2,$config['dec_point'],$_c['thousands_sep']); ?></div></td>
            </tr>
                <?php
            }
            ?>
        ...
        if (($d['tax']) != '0.00'){
            ...
            <tr>
                ...
                <td class="total-value"><div id="total"><?php echo $config['currency_code']; ?> <?php echo number_format($d['tax'],2,$config['dec_point'],$_c['thousands_sep']); ?></div></td>
            </tr>
        <?php
        }
        ?>
        ...
        if($d['credit'] != '0.00'){
            ...
            <tr>
                ...
                <td class="total-value"><div class="due"><?php echo $config['currency_code']; ?> <?php echo number_format($d['total'],2,$config['dec_point'],$_c['thousands_sep']);; ?></div></td>
            </tr>
            <tr>
                <td class="blank"> </td>
                <td colspan="2" class="total-line"><?php echo $_L['Total Paid']; ?></td>
                <td class="total-value"><div class="due"><?php echo $config['currency_code']; ?> <?php echo number_format($d['credit'],2,$config['dec_point'],$_c['thousands_sep']);; ?></div></td>
            </tr>
            <tr>
                <td class="blank"> </td>
                <td colspan="2" class="total-line balance"><?php echo $_L['Amount Due']; ?></td>
                <td class="total-value balance"><div class="due"><?php echo $config['currency_code']; ?> <?php echo $i_due; ?></div></td>
            </tr>
        <?php
        }
        else{
            ...
            <tr>
                ...
                <td class="total-value balance"><div class="due"><?php echo $config['currency_code']; ?> <?php echo number_format($d['total'],2,$config['dec_point'],$_c['thousands_sep']);; ?></div></td>
            </tr>
        <?php
        }
        ?>
